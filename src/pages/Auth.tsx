...
const Auth = () => {
  ...
  const [role, setRole] = useState<"player" | "host">(isHost ? "host" : "player");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md p-8 shadow-hover animate-scale-in">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2 justify-center mb-8">
          <MapPin className="w-10 h-10 text-primary" />
          <span className="text-3xl font-bold italic text-gradient">SportUp</span>
        </Link>
        ...
        <p className="text-muted-foreground text-center mb-6">
          {isSignupMode 
            ? "Join SportUp and start playing today" 
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="font-bold">Find & Book</span>
              ...
              >
                ...
                <span className="font-bold">List Venue</span>
